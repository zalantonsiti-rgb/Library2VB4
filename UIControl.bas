...
' Update ' 18/02/98
'   AssignFieldText excluding the Primary Key (First Field(!)) so that the
'       other Field could be updated. Need to included in HELP.
'***************************************************************************
...
Public Sub CtrEnableLvwViewMain()
    ...
    End If
    frmMDIMainMenu.tbrLibrary.Buttons(8).Enabled = True
    frmMDIMainMenu.tbrLibrary.Buttons(9).Enabled = True
    frmMDIMainMenu.tbrLibrary.Buttons(10).Enabled = True
    If gtTableIndex = "" Then
        gtCurrentIndex = ""
        frmMDIMainMenu.tbrLibrary.Buttons("Find").Enabled = False
...
'Public Sub CtrEnableLvwViewRec()
'    frmMDIMainMenu.mnuViewElip(0).Enabled = True
'    frmMDIMainMenu.mnuViewElip(1).Enabled = True
'    frmMDIMainMenu.mnuViewElip(2).Enabled = True
'    frmMDIMainMenu.mnuViewElip(3).Enabled = True
...
'    frmMDIMainMenu.tbrLibrary.Buttons("lvwView2").Enabled = True
'    frmMDIMainMenu.tbrLibrary.Buttons("lvwView3").Enabled = True
'    frmMDIMainMenu.tbrLibrary.Buttons(12).Value = tbrPressed
'End Sub
...
'    frmContent.lblInfo(0).ZOrder 0
'    frmContent.lblInfo(1).ZOrder 0
'    frmContent.lblInfo(2).ZOrder 0
'    frmContent.lblInfo(3).ZOrder 0
'    frmContent.lblInfo(4).ZOrder 0
'    frmContent.lblInfo(5).ZOrder 0
