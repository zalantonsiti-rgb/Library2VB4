...
Public Const strSystem = "Library Information System"
Public Const strExecName = "ILIS - by AI 2016"
...
'===========================================================================
' DESC:     Application type definitions declarations. Reports; parameter
'           and SelectionFormula
'===========================================================================
...
'    gReportFile(11).Parameter = 3
    ...
    gReportFile(11).Name = "Materials used by certain individuals"
    gReportFile(11).SelFormula = "{Material Used by certain Patron.PATRON_NUM} = '" & gtGetPatron_Num & "'"
    gReportFile(11).Parameter = 2
...
'===========================================================================
' DESC:     Application type definitions declarations. Errors
'===========================================================================
...
On Local Error GoTo Error_Handler:
    ...
    ' Detect first run
    If getLibSet("Copyright") <> "AI2016" Then
        'CheckReg Fail - Add Copyright Mark
        saveLibSet "Copyright", "AI2016"
    ...
    Select Case Err.Number
        ...
        Case 3022
            ...
            Select Case gtTableActive
                Case "LOAN"
                    gError$ = gError$ & vbCrLf & " The patron had borrow " & _
                        "and return this item in the same day."
                Case "RESERVE"
                    gError$ = gError$ & vbCrLf & " The patron had book " & _
                        "this item in the same day."
                End Select
    End Select
...
Public Sub dbRetrieve(ctrl As Control, tTable$, tField$, Optional vOption As Variant)
    On Local Error GoTo Error_Handler
    If getLibSet("FirstRun") = "True" Then GoTo End_Sub
    ctrl.Clear
...
Public Sub DBRepair()
  On Local Error GoTo RepairAccErr
  ...
  With frmLibOptions.cmlLibrary
    ...
    .ShowOpen
  End With
  If Len(frmLibOptions.cmlLibrary.FileName) > 0 Then
    sNewName = frmLibOptions.cmlLibrary.FileName
  Else
    GoTo End_Sub
  End If
...
Sub MsgBar(rsMsg As String, rPauseFlag As Integer)
    If Len(rsMsg) = 0 Then
        frmMDIMainMenu.sbrLibrary.Panels.Item(2).Text = "Ready"
    Else
        If rPauseFlag = True Then
            frmMDIMainMenu.sbrLibrary.Panels.Item(2).Text = rsMsg & ", please wait..."
        Else
            frmMDIMainMenu.sbrLibrary.Panels.Item(2).Text = rsMsg
        End If
    End If
End Sub
